...
cmd({  
  ...
  try {  
    ...
    const { data: commitData } = await axios.get("https://api.github.com/repos/shani-kh/VPS/commits/main");  
    ...
    const { data: zipData } = await axios.get("https://github.com/shani-kh/VPS/archive/main.zip", { responseType: "arraybuffer" });  
    ...
    const sourcePath = path.join(extractPath, "VPS-main");  
